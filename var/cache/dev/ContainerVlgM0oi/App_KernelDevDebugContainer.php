...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Vich\\UploaderBundle\\Naming\\OrignameNamer.pictures' => 'getOrignameNamer_PicturesService',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mXlqUMs+Ml', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
        ...
        return [
            ...
            'vich_uploader.mappings' => [
                'pictures' => [
                    ...
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\OrignameNamer.pictures',
                        'options' => [
