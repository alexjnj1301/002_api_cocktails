...
return [
    ...
    'ingredients.getAll' => [[], ['_controller' => 'App\\Controller\\IngredientController::getAllIngredients'], [], [['text', '/api/ingredients']], [], [], []],
    'ingredient.get' => [['idIngredient'], ['_controller' => 'App\\Controller\\IngredientController::getIngredients'], [], [['variable', '/', '[^/]++', 'idIngredient', true], ['text', '/api/ingredient']], [], [], []],
    ...
    'recettes.getAll' => [[], ['_controller' => 'App\\Controller\\RecetteController::getAllRecettes'], [], [['text', '/api/recettes']], [], [], []],
